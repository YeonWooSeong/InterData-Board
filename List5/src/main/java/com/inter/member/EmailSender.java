...
public class EmailSender  {
	...
	public void sendMail(Email email) throws MessagingException, UnsupportedEncodingException {
        ...
        messageSSL.setFrom(new InternetAddress("syw7200test@gmail.com", "YeonWooSeong")); //setFrom: 보내는 사람의 이메일 주소와, 이름
        ...
        transportSSL.connect("smtp.gmail.com", 465, "syw7200test@gmail.com", "syw7200testsyw7200test");
